...
parser.add_argument('--on-time', type=str, default="30e-6", help="")
parser.add_argument('--off-time', type=str, default="30e-6", help="")
parser.add_argument('--rise-time', type=str, default="15e-6", help="")
parser.add_argument('--fall-time', type=str, default="15e-6", help="")
parser.add_argument('--rise-function', type=str, default="sin", help="")
parser.add_argument('--fall-function', type=str, default="sin", help="")
parser.add_argument('--timescale', type=str, default="1e-6", help="Smallest time unit")
parser.add_argument('--periods', type=int, default=3, help="Periods to run")
