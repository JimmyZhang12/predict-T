...
{
  "names" :       ["fft","qsort"],
  "DecorOnly" :   [23469,42845],
  "IdealSensor" : [23223,43120],
  "uArchEvent" :  [25109,45113],
}

laptop = \
{
  "names" :       ["fft","qsort"],
  "DecorOnly" :   [24765,39465],
  "IdealSensor" : [23945,41855],
  "uArchEvent" :  [57103,53999,51468,64172,28010,49502,50900],
}
...
{
  "names" :       ["fft","qsort"],
  "DecorOnly" :   [26760,42826],
  "IdealSensor" : [27523,48894],
  "uArchEvent" :  [23897,41052],
}
...
# name = ["Average Speedup Across Systems"]
# tick_labels = ["IdealSensor", "uArchEvent"]
# benchmarks = ["Mobile","Latop","Desktop"]
# fname = ["speedup_original.png"]
# bounds = [[0,2,0.1,0]]
# df=[it["IdealSensor"],it["uArchEvent"],it["Signature"]]
