...
{
	"names" :       ["dijkstra","fft","ffti","qsort","sha","toast","untoast"],
	"DecorOnly" :   [23465,58356,55989,57956,18315,33934,50720],
  "IdealSensor" : [25470,58356,55989,60857,18315,35955,55040],
  "uArchEvent" :  [23465,58356,55989,62088,18452,37111,51255],
  "Signature" :   [23539,58834,55450,58273,18309,35038,50343],
  "T.a.S." :      [35515,58643,56262,63405,24579,41389,61009],
  "InstPending" : [26117,58361,56126,62657,21777,40431,52858]
}

laptop = \
{
	"names" :       ["dijkstra","fft","ffti","qsort","sha","toast","untoast"],
	"DecorOnly" :   [12491,53481,50600,57762,15462,28794,36208],
  "IdealSensor" : [19157,53604,50600,57762,20680,40182,43012],
  "uArchEvent" :  [12899,53481,50600,57762,16263,33920,36303],
  "Signature" :   [12289,53593,49958,57593,15443,28485,37635],
  "T.a.S." :      [19093,53746,50729,64126,19331,33115,42520],
  "InstPending" : [16810,53608,50727,59512,21247,37304,42428]
}
