...
CYCLE_END = 30000
SIGNATURE_LENGTH = 64
harvard = util.Harvard(TABLE_HEIGHT=2000,SIGNATURE_LENGTH=SIGNATURE_LENGTH,HYSTERESIS=0.005,EMERGENCY_V=1.358)
...
ax1.set_title('Signature', fontsize=14)
...
plt.savefig(HOME+'/passat/plot/12-3_frontend_Acc_vs_LT' + '_' + PREDICTOR + '_' + CLASS + '_' + TEST +'.png')
